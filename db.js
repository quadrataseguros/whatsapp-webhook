...
db.exec(`
  ...
  -- Posts publicados pelo servidor (publicador.js). A chave é a pasta do post
  -- em publicacoes/; é ela que garante que nada seja publicado duas vezes,
  -- mesmo com o servidor reiniciando no meio do caminho.
